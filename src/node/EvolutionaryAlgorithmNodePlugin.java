 ...
 * @author basem
 */
public class EvolutionaryAlgorithmNodePlugin extends Plugin {
    // The shared instance.
    private static EvolutionaryAlgorithmNodePlugin plugin;

    /**
     * The constructor.
     */
    public EvolutionaryAlgorithmNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static EvolutionaryAlgorithmNodePlugin getDefault() {
        return plugin;
    }
